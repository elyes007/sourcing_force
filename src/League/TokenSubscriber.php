...
use App\Controller\SalesForce\AuthController;
...
final class TokenSubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelController(FilterControllerEvent $event): void
    {
         ...
         * In the case of an Api Platform controller, $controller is a class
         */
        if (\is_array($controller)) {
            $controller = $controller[0];
        }

        if (!$controller instanceof OAuthController && !$controller instanceof AuthController) {
